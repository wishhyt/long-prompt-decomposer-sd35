...
base_path = "//zoo/Shui-VL/LLM4GEN-models/"
model_path = "unet"
llm_projector_path = f"projector.pth"
llm_projector = LLMFusionModule(768, 2048, 8)
msg = llm_projector.load_state_dict(torch.load(base_path+llm_projector_path))
llm_projector.to("cuda", dtype=torch.float16).eval()
unet = UNet2DConditionModel.from_pretrained(
    base_path+model_path,
    # "//zoo/runwayml/stable-diffusion-v1-5",
).to("cuda", dtype=torch.float16)

t5_model = RankGenEncoder("//zoo/kalpeshk2011/rankgen-t5-xl-all")
...
save_dir = "//samples/long_PDD/sd2/dm_bench/llm4gen"
