...
def main():
    ...
    if args.ckpt is not None:
        # ella_sd = load_file("//zoo/ella/ella-sd1.5-tsc-t5xl.safetensors", device="cpu")
        # ella_sd.pop('connector.latents')
        # mk, uk = decomposer.mask_head.load_state_dict(ella_sd, strict=False)
        # print(f'loading ella weights with {mk} missing and {uk} unexpected')
    ...
    caption2embed_simple = lambda captions: caption2embed(captions, [None, tokenizer_t5], [None, text_encoder_t5],
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(*trainable_module):
                ...
                if args.dropout_v1:
                    ...
                    token_hidden_states = decomposer(encoder_hidden_states, timesteps)     # a list of length `num_components`, each element is a batch
